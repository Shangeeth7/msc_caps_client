...
function BookAppointment() {
  ...
  const getMechanicData = async () => {
    try {
      ...
      const response = await axios.post(
        "https://motorcycle-service.onrender.com/api/mechanic/get-mechanic-info-by-id",
        {
  ...
  const checkAvailability = async () => {
    try {
      dispatch(showLoading());
      const response = await axios.post(
        "https://motorcycle-service.onrender.com/api/user/check-booking-avilability",
        {
          mechanicId: params.mechanicId,
          date: date,
          time: time,
  ...
  const bookNow = async () => {
    ...
    try {
      dispatch(showLoading());
      const response = await axios.post(
        "https://motorcycle-service.onrender.com/api/user/book-appointment",
        {
          mechanicId: params.mechanicId,
          userId: user._id,
